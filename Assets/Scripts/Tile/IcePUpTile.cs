...
[CreateAssetMenu(fileName = "IcePUpTile", menuName = "ScriptableObjects/Tiles/IcePUpTile", order = 2)]
public class IcePUpTile : BreakableBrickTile {
    ...
    public override bool Interact(MonoBehaviour interacter, InteractionDirection direction, Vector3 worldLocation) {
        ...
        if ((interacter is PlayerController) || (interacter is KoopaWalk koopa && koopa.previousHolder != null)) {
            ...
            spawnResult = player.state <= Enums.PowerupState.Small ? "Mushroom" : "IceFlower";
        }
